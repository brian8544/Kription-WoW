...
- [Core Binaries](https://github.com/brian8544/Kription-WoW/releases/download/Release/binaries.zip "Core Binaries"")
- [Databases (SQL)](https://github.com/brian8544/Kription-WoW/releases/download/Database/sql.zip "Databases (SQL)"")
